...
export default function KinikhServiceTabs() {
  ...
  return (
    <section className="w-full overflow-hidden bg-white pb-20 md:pb-28 lg:pb-32">
      {/* Minimal section header */}
      <div className="bg-white px-8 pb-6 pt-20 md:px-14 md:pt-28 lg:px-20 lg:pt-32">
        <span
        ...
        return (
          ...
          >
            ...
            <img
              ...
              style={{
                filter:
                  "sepia(0.18) saturate(0.80) brightness(0.68) contrast(1.06)",
            ...
            <div
              ...
              style={{
                background: "rgba(138,79,24,0.18)",
